...
@AllArgsConstructor
@NoArgsConstructor
public class CombinedBatteryVariationResponseDto {
    ...
    public CombinedBatteryVariationResponseDto(LocalDateTime date, Integer curSleep, Integer goalSleep, Integer sleepVariation, Integer curActivity, Integer goalActivity, Integer activityVariation, String chargeName, String valueName, Integer chargeVariation) {
