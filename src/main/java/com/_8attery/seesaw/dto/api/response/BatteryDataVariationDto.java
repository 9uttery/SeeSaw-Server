...
@AllArgsConstructor
@NoArgsConstructor
public class BatteryDataVariationDto {
    ...
    public BatteryDataVariationDto(LocalDateTime date, Integer curSleep, Integer goalSleep, Integer sleepVariation, Integer curActivity, Integer goalActivity, Integer activityVariation) {
